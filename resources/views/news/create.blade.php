...
<section class="col-md-12 body">
	<div class="col-md-offset-2 col-md-8 news-box">
		<form action="{{ route('news_store') }}" method="post">
			...
			<div class="form-group newst">
				<label for="title" class="col-sm-2 control-label">
					标题
				</label>
				<div class="col-sm-9">
					<input class="form-control" type="text" id="title" name="news_title">
				</div>
			</div>
			<div class="clear"></div>
			<div class="form-group newsc">
				<label for="content" class="col-sm-2 control-label">
					正文
				</label>
				<div class="col-sm-9">
					<textarea id="content" name="news_content" class="form-control"></textarea>
